...
export default function Navbar() {
    ...
    return (
        <div className="relative top-4 mx-2 p-3 px-8 flex justify-between items-center bg-white rounded-full">
            ...
            <div className={`${isOpen ? 'flex' : 'hidden'} flex-col lg:flex lg:flex-row lg:w-3/5 lg:justify-between lg:items-center absolute lg:relative top-full lg:top-0 right-0 lg:right-auto bg-white lg:bg-transparent z-20 w-full lg:w-auto`}>
